...
public class AdditionalTest extends TestCase {
	...
	public void testGetPredecessorNode() {
		...
		// The servers in the array list are already sorted according to their positions
		// in the ring...
		assertEquals(servers.get(0), metaData.getPredecessor(servers.get(1)));
		assertEquals(servers.get(1), metaData.getPredecessor(servers.get(2)));
		assertEquals(servers.get(2), metaData.getPredecessor(servers.get(0)));
	}
